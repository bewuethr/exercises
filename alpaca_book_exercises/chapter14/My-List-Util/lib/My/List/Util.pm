...
My::List::Util - Simple list utils
...
Part of the exercises in the Alpaca book.
...
Takes a list a returns the sum of its elements.
...
Takes a list and returns a shuffled list; implements the Fisher-Yates shuffle
from perlfaq4.
